...
type UserAPI struct {
	...
	Status         *int             `json:"status,omitempty" example:"0" gorm:"type:tinyint(1)"`                                                                            // Status
	StatusVerified *int             `json:"status_verified,omitempty" example:"0" gorm:"type:tinyint(1)"`                                                                   // Status Verified
	IsAdmin        *int             `json:"is_admin,omitempty" gorm:"type:tinyint(1)" example:"0"`                                                                          // Status Verified
